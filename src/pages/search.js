...
const Search = ({ addToConsideration }) => {
    ...
    const handleAddToConsideration = (item) => {
        addToConsideration(item);
        setPopupMessage(`Added restaurant to consideration`);
                    ...
                    filteredItems.map((item, index) => (
                        <div key={index} className="item_card">
                            ...
                            <div className="item_info">
                                ...
                                <button className="add_button" onClick={() => handleAddToConsideration(item)}>Add to Consideration</button>
